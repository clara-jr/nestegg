...
const CATEGORY_KEYWORDS: ReadonlyArray<[ExpenseCategory, RegExp]> = [
  ['Animales', /VETERINAR|HV VETERIOS|VERACR|VERACRUZ|UNAVETS GF|ERVET|HVCHOPERA|FUNDACION ROF COD|ZOOPLUS|KIWOKO|DIAGER VET|GATTOS/],
  ['Peluquería', /PELUQUERIA|COLORES Y FORMAS/],
  ['Gimnasio', /AYTO MADRID DEPOR|AYTO.MADRID-DEPOR|\bGYM\b|GIMNASIO|VIVAGYM|ANYTIME FITNESS|BASIC FIT/],
  ['Regalos', /REGALO|CUMPLE/],
  ['Suscripciones', /SPOTI|NETFLIX|HBO\s?MAX|MAX\.COM|DISNEY|SPOTIFY|APPLE\.COM|APPLE BILL|ICLOUD|GOOGLE (ONE|STORAGE)|YOUTUBE|AMAZON PRIME|PRIME VIDEO|MICROSOFT 365|M365|NORDVPN|PATREON|CHATGPT|OPENAI|ANTHROPIC|CLAUDE|GITHUB|NOTION|DROPBOX|CRUNCHYROLL|DAZN|MUBI|FILMIN/],
  ...
  ['Vivienda', /ALQUILER|ARRENDAMIENTO|HIPOTECA|COMUNIDAD DE|ADMINISTRADOR FINCAS|INMOBILIARIA|IBI\b|COMUNIDAD|CDAD/],
  ...
  ['Compras', /AMAZON|BAZAR|YVES ROCHER|PERFUMERIA|REDOUTE|TRAMASMAS|ALIEXPRESS|EL CORTE INGLES|MEDIA MARKT|IKEA|WALLAPOP|\bEBAY\b|PC COMPONENTES|MIRAVIA|\bTEMU\b|SPRAYGROUND|LEROY MERLIN|BRICO|HOGAR|PAYPAL/],
