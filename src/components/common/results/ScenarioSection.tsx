...
export function ScenarioSection({ title = 'Datos del escenario', gridCols = 'grid grid-cols-1 min-[500px]:grid-cols-2 lg:grid-cols-4 gap-3', children }: Readonly<ScenarioSectionProps>) {
  return (
