      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          <main>
                ...
                <section className="-mx-6 sm:-mx-8 px-6 sm:px-8 pt-5 border-t border-gray-200">
                  ...
                  <div className="mt-3 bg-amber-50 border border-amber-200 rounded-lg px-4 py-3">
                    <p className="text-xs text-amber-800 leading-relaxed">
                      <strong>⚠️ Nota:</strong> {result.constraintType === 'income'
                      ...
                      } El ratio de esfuerzo ({params.debtToIncomeRatio}%) se aplica sobre el ingreso neto mensual
                      {params.members.length > 1 ? ' conjunto' : ''} de {formatCurrency(result.totalNetMonthlyIncome)}.
                    </p>
                  </div>
                </section>
              </section>
            ...
            {!hasSalary && (
              <section className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 shadow-sm">
                <p className="text-sm text-gray-500 text-center">Introduce al menos un salario para ver los resultados.</p>
              </section>
            )}
          </main>
        </div>
